        ...
        public static List<Postagem> ListaDePostagem(string path, Form1 frm, string tipoArquivo)
        {
            ...
            if (tipoArquivo.Equals("txt"))
            {
                ...
                foreach(string l in lista)
                {
                    ...
                    {
                        oFormatacao.Valor = (from s in l select l.Substring(oFormatacao.Inicio - 1, oFormatacao.Tamanho)).FirstOrDefault();                        
                    }
            ...
            #region Processa Excel xls
            if (tipoArquivo.Equals("CENGAGE - EXCEL"))
            {
